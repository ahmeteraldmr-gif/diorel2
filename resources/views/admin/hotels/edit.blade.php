        ...
        <form action="{{ route('admin.hotels.update', $hotel->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="lang-pane" data-lang="en">
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc[en]" id="desc_en" class="form-control" required>{{ old('desc.en', $hotel->desc['en'] ?? '') }}</textarea>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                <div>
                    ...
                    <select name="theme_color" id="theme_color" class="form-control">
                        <option value="white" {{ old('theme_color', $hotel->theme_color) == 'white' ? 'selected' : '' }}>Beyaz (Açık Tema)</option>
                        <option value="black" {{ old('theme_color', $hotel->theme_color) == 'black' ? 'selected' : '' }}>Siyah (Koyu Tema)</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="photo_layout" id="photo_layout" class="form-control">
                        <option value="left" {{ old('photo_layout', $hotel->photo_layout) == 'left' ? 'selected' : '' }}>Fotoğraf Solda, Yazı Sağda</option>
                        <option value="right" {{ old('photo_layout', $hotel->photo_layout) == 'right' ? 'selected' : '' }}>Fotoğraf Sağda, Yazı Solda</option>
                    </select>
                </div>
            </div>
