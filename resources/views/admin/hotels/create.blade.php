...
@section('page_title', 'Yeni Otel Ekle')
@section('page_subtitle', 'Koleksiyona eklenecek yeni lüks otelin detaylarını girin.')

@section('content')
    <div class="panel-card">
        <div class="panel-card-header">
            <h3 class="panel-card-title"><i class="fas fa-plus-circle"></i> Otel Formu</h3>
        ...
        <form action="{{ route('admin.hotels.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="lang-pane active" data-lang="tr">
                <div class="form-group">
                    ...
                    <input type="text" name="name[tr]" id="name_tr" class="form-control" placeholder="Örn: Maxx Royal Bodrum Resort" value="{{ old('name.tr') }}" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_tr">Kategori / Etiket (TR)</label>
                    <input type="text" name="tag[tr]" id="tag_tr" class="form-control" placeholder="Örn: Ultra Lüks & Resort" value="{{ old('tag.tr') }}">
                </div>
            ...
            <div class="lang-pane" data-lang="en">
                <div class="form-group">
                    ...
                    <input type="text" name="name[en]" id="name_en" class="form-control" placeholder="e.g. Maxx Royal Bodrum Resort" value="{{ old('name.en') }}" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="tag_en">Category / Tag (EN)</label>
                    <input type="text" name="tag[en]" id="tag_en" class="form-control" placeholder="e.g. Ultra Luxury & Resort" value="{{ old('tag.en') }}">
                </div>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        ...
                        <div style="margin-top: 1rem;">
                            ...
                            <input type="text" name="img_url" id="img_url" class="form-control" placeholder="Örn: foto.img/otel_maxx.jpg" value="{{ old('img_url') }}">
                        </div>
                    </div>
                </div>
